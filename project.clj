(defproject clj-web-pedestal "0.0.1-SNAPSHOT"
  ...
  :profiles {:dev {:aliases {"run-dev" ["trampoline" "run" "-m" "clj-web-pedestal.server/run-dev"]}
                   :dependencies [[io.pedestal/pedestal.service-tools "0.5.8"]]}
             :uberjar {:aot [clj-web-pedestal.server]}}
  :main ^{:skip-aot true} clj-web-pedestal.server)
